...
set msg=[%date% %time%] - App Domain [%APPDOM%] Force shutdown and then Clean IPC
echo %msg% >> %LOGFILE%
psadmin -c shutdown! -d %APPDOM%
psadmin -c cleanipc  -d %APPDOM%
set msg=[%date% %time%] - App Domain [%APPDOM%] Reconfiguring...
echo %msg% >> %LOGFILE%
...
cd /d %PS_HOME%\appserv
@REM App Domain
set msg=[%date% %time%] - App Domain [%APPDOM%] - Server Status
echo %msg% >> %LOGFILE%
...
set msg=[%date% %time%] - PIA Domain [%PIADOM%] - Server Status
echo %msg% >> %LOGFILE%

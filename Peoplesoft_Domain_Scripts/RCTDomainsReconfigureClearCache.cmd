...
set msg=[%date% %time%] - App Domain#1 [%APPDOM%] Force shutdown and then Clean IPC
echo %msg% >> %LOGFILE%
psadmin -c shutdown! -d %APPDOM%
psadmin -c cleanipc  -d %APPDOM%
set msg=[%date% %time%] - App Domain#1 [%APPDOM%] Reconfiguring...
echo %msg% >> %LOGFILE%
psadmin -c configure -d %APPDOM%
@REM App Server Domain#2
set msg=[%date% %time%] - App Domain#2 [%APPDOM_EXT%] Force shutdown and then Clean IPC
echo %msg% >> %LOGFILE%
psadmin -c shutdown! -d %APPDOM_EXT%
psadmin -c cleanipc  -d %APPDOM_EXT%
set msg=[%date% %time%] - App Domain#2 [%APPDOM_EXT%] Reconfiguring...
echo %msg% >> %LOGFILE%
...
@REM =================================
set msg=[%date% %time%] - Prcs Domain [%PRCSDOM%] Kill and then Clean IPC
echo %msg% >> %LOGFILE%
psadmin -p kill      -d %PRCSDOM%
psadmin -p cleanipc  -d %PRCSDOM%
set msg=[%date% %time%] - Prcs Domain [%PRCSDOM%] Reconfiguring...
echo %msg% >> %LOGFILE%
psadmin -p configure -d %PRCSDOM%

set msg=[%date% %time%] - Completed - Bounced and Cleaned IPC for App and Prcs Domains
echo %msg% >> %LOGFILE%
...
set msg=[%date% %time%] - Completed - Cache Deleted for App and Prcs Domains
echo %msg% >> %LOGFILE%
...
set msg=[%date% %time%] - Completed - Deleted PIA Cache
echo %msg% >> %LOGFILE%
...
@REM =================================
:JoltPort2Check
set msg=[%date% %time%] - Checking JOLT port [%JOLTPORT_EXT%]
echo %msg% >> %LOGFILE%
set /a counter=1
:JoltPort2Loop
...
@REM =================================
:PIAPort2Check
set msg=[%date% %time%] - Checking PIA port [%PIAPORT_EXT%]
echo %msg% >> %LOGFILE%
set /a counter=1
:PIAPort2Loop
...
cd /d %PS_HOME%\appserv
@REM App Domains
set msg=[%date% %time%] - App Domain#1 [%APPDOM%] - Server Status
echo %msg% >> %LOGFILE%
psadmin -c sstatus  -d %APPDOM% >> %LOGFILE% 2>&1
set msg=[%date% %time%] - App Domain#2 [%APPDOM_EXT%] - Server Status
echo %msg% >> %LOGFILE%
psadmin -c sstatus  -d %APPDOM_EXT% >> %LOGFILE% 2>&1
@REM Prcs Domain
set msg=[%date% %time%] - Prcs Domain [%PRCSDOM%] - Server Status
echo %msg% >> %LOGFILE%
...
set msg=[%date% %time%] - PIA Domain#1 [%PIADOM%] - Server Status
echo %msg% >> %LOGFILE%
call singleserverStatus.cmd >> %LOGFILE% 2>&1
cd /d %PS_CFG_HOME%\webserv\%PIADOM_EXT%\bin
set msg=[%date% %time%] - PIA Domain#2 [%PIADOM_EXT%] - Server Status
echo %msg% >> %LOGFILE%
call singleserverStatus.cmd >> %LOGFILE% 2>&1
